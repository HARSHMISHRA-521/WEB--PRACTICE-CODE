//  console.log("Hello This Is Harsh Mishra ")
// first program hosted in backend
...
<style>
    ...
    @media only screen and (max-width:300px) {
        body {
            background-color: rgb(8, 237, 172);
        }
...
<body>
    <div class="container ">
        ...
        <section class="bdr">
            <h2>This is the first website hosted by using backend </h2>
    ...
    <footer class="bdr">Copyright HARSH_MISHRA 2023</footer>
